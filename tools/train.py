...
# Compatibility shim: pkl files saved with NumPy 2.x reference numpy._core,
# which does not exist in NumPy 1.x.  Register an import hook that transparently
# redirects numpy._core.* → numpy.core.* so pickle.load succeeds.
import sys as _sys
import numpy as _np
if not hasattr(_np, '_core'):
    ...
    class _NumpyCoreCompat:
        ...
        def load_module(self, fullname):
            ...
            new_name = fullname.replace('numpy._core', 'numpy.core', 1)
            try:
