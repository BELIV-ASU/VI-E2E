...
class CustomObjectRangeFilter(object):
    ...
    def __call__(self, input_dict):
        ...
        #ANIRUDH EDITED THIS
        gt_bboxes_3d_infra = copy.deepcopy(input_dict['gt_bboxes_3d'])
        gt_labels_3d_infra = copy.deepcopy(input_dict['gt_labels_3d'])
        gt_attr_labels_infra = copy.deepcopy(input_dict['attr_labels'])
        ...
        #ANIRUDH EDITED
        input_dict['gt_bboxes_3d_infra'] = gt_bboxes_3d_infra
        input_dict['gt_labels_3d_infra'] = gt_labels_3d_infra
        input_dict['gt_attr_labels_infra'] = gt_attr_labels_infra
...
class CustomObjectNameFilter(object):
    ...
    def __call__(self, input_dict):
        ...
        #ANIRUDH EDITED THIS
        gt_labels_3d_infra = input_dict['gt_labels_3d_infra']
        gt_bboxes_mask_infra = np.array([n in self.labels for n in gt_labels_3d_infra],
                                  dtype=np.bool_)
        input_dict['gt_bboxes_3d_infra'] = input_dict['gt_bboxes_3d_infra'][gt_bboxes_mask_infra]
        input_dict['gt_labels_3d_infra'] = input_dict['gt_labels_3d_infra'][gt_bboxes_mask_infra]
        input_dict['gt_attr_labels_infra'] = input_dict['gt_attr_labels_infra'][gt_bboxes_mask_infra]
