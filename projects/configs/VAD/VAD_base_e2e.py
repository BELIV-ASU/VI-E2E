...
point_cloud_range = [0, -51.2, -5.0, 102.4, 51.2, 3.0] #[-51.2, -51.2, -5.0, 51.2, 51.2, 3.0] #[-15.0, -30.0, -2.0, 15.0, 30.0, 2.0]
voxel_size = [0.15, 0.15, 0.4] #[0.15, 0.15, 4]
...
model = dict(
    ...
    #pretrained=dict(img='torchvision://resnet101'),
    img_backbone=dict(
        type='ResNet',
        depth=101,
        num_stages=4,
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range= [-10.0, -61.2, -10.0, 112.4, 61.2, 10.0], #[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0], #[-20, -35, -10.0, 20, 35, 10.0],
            pc_range=point_cloud_range,
            max_num=300, #100,
        ...
        map_bbox_coder=dict(
            ...
            post_center_range= [-61.2, -112.4, -61.2, -112.4, 61.2, 112.4, 61.2, 112.4], #[-50.0, -55.0, -50.0, -55.0, 50.0, 55.0, 50.0, 55.0], #[-20, -35, -20, -35, 20, 35, 20, 35],
            pc_range=point_cloud_range,
            max_num=50,
            voxel_size=voxel_size,
...
#load_from = '/home/jmeng18/VADV2X-main/vadv2x_base_pretrain/infra_extracted.pth'
#load_from = '/home/jmeng18/VADV2X-main/vadv2x_base_pretrain/extracted.pth'
#load_from="/home/jmeng18/VADV2X-main/ckpts/backbone.pth"
