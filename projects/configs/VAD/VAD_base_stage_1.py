...
point_cloud_range = [-100.0, -100.0, -5.0, 100.0, 100.0, 5.0] #[-15.0, -30.0, -2.0, 15.0, 30.0, 2.0]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            post_center_range=[-110, -100, -10, 100, 100, 10], #[-20, -35, -10.0, 20, 35, 10.0],
            pc_range=point_cloud_range,
            max_num=300, #100,
...
data_root = '/scratch/jmeng18/V2X-Seq-SPD-New/' #'data/nuscenes/'
